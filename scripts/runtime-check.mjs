...
for(const needle of ['mediaSession','MediaMetadata','setActionHandler','setPositionState','audio_error','AUDIO UNAVAILABLE','NETWORK SLOW','portalEnabled','Billing support','Subscription cancellation']){
...
console.log('PASS: Media Session controls, audio resilience and no-dead-end billing support fallback');
